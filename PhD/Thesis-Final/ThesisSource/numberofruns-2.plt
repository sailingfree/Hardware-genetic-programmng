...
set xlabel "Time available for experiments (hours)" 0.000000,0.000000  ""
set x2label "" 0.000000,0.000000  ""
set timefmt "%d/%m/%y\n%H:%M"
#set xrange [ 1.000000 : 1000.00 ] noreverse nowriteback
set x2range [ * : * ] noreverse nowriteback  # (currently [-10.0000:10.0000] )
set ylabel "Number of runs" 0.000000,0.000000  ""
set y2label "" 0.000000,0.000000  ""
set yrange [ 1.0 : * ] noreverse nowriteback  # (currently [-10.0000:10.0000] )
...
Trunsw=24.0
Trun=Trunsw/500
plot [x=1:150]  (((x-Tdev)/Trun > 1.0) ? (x-Tdev)/Trun : 0)  title "Hardware", (((x-Tdevsw)/Trun > 1.0) ? (x-Tdevsw)/Trunsw : 0)  title "Software"
set output "numberofruns-2.eps"

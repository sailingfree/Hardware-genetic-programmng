/* diequick.f -- translated by f2c (version 19950110).
...
static real c_b46 = (float)2.;
static integer c__2 = 2;
static integer c__20 = 20;
static integer c__42 = 42;
static real c_b150 = (float)100.;
static integer c__10 = 10;
static integer c__8000 = 8000;
static integer c__4096 = 4096;
static real c_b237 = (float).75;
static real c_b238 = (float).72222222222222221;
static real c_b239 = (float).69444444444444442;
static integer c__5 = 5;
static integer c__6 = 6;
static integer c__8 = 8;
static integer c__25 = 25;
static integer c__3 = 3;
static doublereal c_b513 = 2.;
static integer c__100 = 100;
static real c_b760 = (float).5;
static doublereal c_b761 = .5;
static doublereal c_b764 = .33333;
static integer c__99 = 99;

void printstart(char *s);
void printend(void);

/* c************top of file */
/*  allbrank.obj cdosum.obj cdoperm5.obj asort.obj kstest.obj phi.obj */
/* Main program */ MAIN__()
{
    /* Format strings */
    static char fmt_845[] = "(a25)";
    static char fmt_399[] = "(\002\002)";
    ...
    integer s_wsle(), do_lio(), e_wsle(), s_rsfe(), do_fio(), e_rsfe(), 
	    f_open(), s_wsfe(), e_wsfe();

    /* Local variables */
    static char filename[25];
    extern /* Subroutine */ int cdbinrnk_(), craptest_(), sqeez_(), sknt1s_(),
	     cdbday_(), wknt1s_(), rank3132_(), cdpark_(), cdosum_(), 
	    cdbitst_();
    ...
    static cilist io___9 = { 0, 3, 0, fmt_399, 0 };
    static cilist io___10 = { 0, 6, 0, fmt_399, 0 };
    static cilist io___11 = { 0, 3, 0, fmt_399, 0 };
    static cilist io___12 = { 0, 6, 0, fmt_399, 0 };
    static cilist io___13 = { 0, 3, 0, fmt_399, 0 };
    static cilist io___14 = { 0, 6, 0, fmt_399, 0 };
    static cilist io___15 = { 0, 3, 0, fmt_399, 0 };
    static cilist io___16 = { 0, 6, 0, fmt_399, 0 };
    static cilist io___17 = { 0, 3, 0, fmt_399, 0 };
    static cilist io___18 = { 0, 6, 0, fmt_399, 0 };
    static cilist io___19 = { 0, 3, 0, fmt_399, 0 };
    static cilist io___20 = { 0, 6, 0, fmt_399, 0 };
    static cilist io___21 = { 0, 3, 0, fmt_399, 0 };
    static cilist io___22 = { 0, 6, 0, fmt_399, 0 };
    static cilist io___23 = { 0, 3, 0, fmt_399, 0 };
    static cilist io___24 = { 0, 6, 0, fmt_399, 0 };
    static cilist io___25 = { 0, 3, 0, fmt_399, 0 };
    static cilist io___26 = { 0, 6, 0, fmt_399, 0 };
    static cilist io___27 = { 0, 3, 0, fmt_399, 0 };
    static cilist io___28 = { 0, 6, 0, fmt_399, 0 };
    static cilist io___29 = { 0, 3, 0, fmt_399, 0 };
    static cilist io___30 = { 0, 6, 0, fmt_399, 0 };
    static cilist io___31 = { 0, 3, 0, fmt_399, 0 };
    static cilist io___32 = { 0, 6, 0, fmt_399, 0 };
    static cilist io___33 = { 0, 3, 0, fmt_399, 0 };
    static cilist io___34 = { 0, 6, 0, fmt_399, 0 };
    static cilist io___35 = { 0, 3, 0, fmt_399, 0 };
    static cilist io___36 = { 0, 6, 0, fmt_399, 0 };

    s_wsle(&io___1);
    do_lio(&c__9, &c__1, "   This program runs the full DIEHARD battery of t\
ests,", 55L);
    e_wsle();
    s_wsle(&io___2);
    do_lio(&c__9, &c__1, " giving the p-values but little explanation. ", 45L)
	    ;
    e_wsle();
    s_wsle(&io___3);
    do_lio(&c__9, &c__1, " Enter name of file to be tested:", 33L);
    e_wsle();
    s_rsfe(&io___4);
...
{
    /* Format strings */
    static char fmt_22[] = "(\002\002,f7.5)";
    ...
    static integer nint, kpow, i, j, k, l, n;
    static real s;
    ...
    /* Fortran I/O blocks */
    static cilist io___46 = { 0, 3, 0, 0, 0 };
    static cilist io___47 = { 0, 3, 0, 0, 0 };
    static cilist io___48 = { 0, 6, 0, 0, 0 };
    static cilist io___49 = { 0, 6, 0, 0, 0 };
    static cilist io___50 = { 0, 3, 0, 0, 0 };
    static cilist io___51 = { 0, 6, 0, 0, 0 };
    static cilist io___69 = { 0, 3, 0, fmt_22, 0 };
    static cilist io___70 = { 0, 6, 0, fmt_22, 0 };
...
/* ***********INITIALIZE***************** */
    s_wsle(&io___46);
    i__1 = kpow - 20;
    mu = exp(-(doublereal)pow_ri(&c_b46, &i__1)) * 1048576;
/* *****MAIN LOOP********* */
/* **** GET INITIAL WORD */
    j = jtbl_();
    j &= 1048575;
...
{
    /* Format strings */
    static char fmt_28[] = "(\002\002, f7.5)";
    static char fmt_25[] = "(\002\002, f8.6)";
    ...
    /* Fortran I/O blocks */
    static cilist io___90 = { 0, 3, 0, fmt_28, 0 };
    static cilist io___91 = { 0, 6, 0, fmt_28, 0 };
    static cilist io___95 = { 0, 6, 0, fmt_25, 0 };
    static cilist io___96 = { 0, 3, 0, fmt_25, 0 };
...
ftnlen filename_len;
{
    ...
    /* Format strings */
    //static char fmt_72[] = "(8x,\002\002  p-Qvalue=\002,f8.6)";
    static char fmt_72[] = "(\002\002,f8.6)";
    ...
    static integer jkk;
    static real tbl[43], sig;
    extern integer jkreset_();

    /* Fortran I/O blocks */
    static cilist io___113 = { 0, 6, 0, fmt_72, 0 };
    static cilist io___114 = { 0, 3, 0, fmt_72, 0 };
...
{
    /* Format strings */
    static char fmt_27[] = "(\002\002,f8.6)";
    static char fmt_26[] = "(\002\002,f8.6)";
    ...
    /* Builtin functions */
    integer s_wsfe(), do_fio(), e_wsfe(), s_wsle(), e_wsle();
    double sqrt();
    ...
    /* Fortran I/O blocks */
    static cilist io___131 = { 0, 6, 0, fmt_27, 0 };
    static cilist io___132 = { 0, 3, 0, fmt_27, 0 };
    static cilist io___139 = { 0, 6, 0, fmt_26, 0 };
    static cilist io___140 = { 0, 3, 0, fmt_26, 0 };
...
#define xy ((real *)equiv_0)
    ...
    /* Fortran I/O blocks */
    static cilist io___166 = { 0, 3, 0, fmt_31, 0 };
    static cilist io___167 = { 0, 6, 0, fmt_31, 0 };
...
int n__;
{
    ...
    /* Fortran I/O blocks */
    static cilist io___172 = { 0, 1, 0, 0, 0 };
...
{
    /* Format strings */
    static char fmt_812[] = "(\002\002,f8.6)";
    static char fmt_813[] = "(\002\002,f8.6)";
    ...
    static integer jkk, nxs;
    extern integer jkreset_();

    /* Fortran I/O blocks */
    static cilist io___191 = { 0, 3, 0, fmt_812, 0 };
    static cilist io___192 = { 0, 6, 0, fmt_812, 0 };
    static cilist io___193 = { 0, 3, 0, fmt_813, 0 };
    static cilist io___194 = { 0, 6, 0, fmt_813, 0 };
...
integer *ifault;
{
	...
	integer fill_10[1];
	real e_11[6];
	} equiv_208 = { (float)4529.4, {0}, (float)9044.9, (float)18097., {0},
...
{
    /* Format strings */
    static char fmt_25[] = "(\002\002,f7.5)";
    static char fmt_77[] = "(\002\002,f8.6)";
    static char fmt_78[] = "(\002\002,f8.6)";
    ...
    /* Fortran I/O blocks */
    static cilist io___229 = { 0, 6, 0, fmt_25, 0 };
    static cilist io___230 = { 0, 3, 0, fmt_25, 0 };
    static cilist io___239 = { 0, 3, 0, fmt_77, 0 };
    static cilist io___240 = { 0, 6, 0, fmt_77, 0 };
    static cilist io___241 = { 0, 3, 0, fmt_78, 0 };
    static cilist io___242 = { 0, 6, 0, fmt_78, 0 };
	...
	i__2 = k - 2;
	i__3 = k - 2;
	e[k - 1] = (pow_ri(&c_b237, &i__1) * (float)27. + pow_ri(&c_b238, &
		i__2) * (float)40. + pow_ri(&c_b239, &i__3) * (float)55.) / (
		float)648.;
/* L3: */
	sum += e[k - 1];
    }
...
ftnlen filename_len;
{
    ...
    /* Format strings */
    static char fmt_22[] = "(\002\002,f6.4)";
    ...
    static cilist io___255 = { 0, 3, 0, 0, 0 };
    static cilist io___256 = { 0, 3, 0, 0, 0 };
    static cilist io___257 = { 0, 3, 0, 0, 0 };
    static cilist io___276 = { 0, 3, 0, fmt_22, 0 };
    static cilist io___277 = { 0, 6, 0, fmt_22, 0 };
...
/* *********** INITIALIZE***************** */
		i__2 = kpow - 20;
		true = exp(-(doublereal)pow_ri(&c_b46, &i__2)) * 1048576;
/* *****MAIN LOOP********* */
		i__2 = ntries;
		for (nt = 1; nt <= i__2; ++nt) {
/*                  ********SET W-TABLE TO ZEROS******* */
...
integer *w;
{
    ...
    /* Fortran I/O blocks */
    static cilist io___283 = { 0, 6, 0, fmt_21, 0 };
...
ftnlen filename_len;
{
    ...
    /* Format strings */
    static char fmt_821[] = "(\002\002,f8.6)";
    ...
    static cilist io___306 = { 0, 3, 0, 0, 0 };
    static cilist io___307 = { 0, 3, 0, fmt_821, 0 };
    static cilist io___308 = { 0, 6, 0, fmt_821, 0 };
...
ftnlen filename_len;
{
    ...
    /* Format strings */
    static char fmt_23[] = "(\002\002,f7.5)";
    static char fmt_31[] = "(\002\002,f8.6)";
    ...
    /* Fortran I/O blocks */
    static cilist io___336 = { 0, 6, 0, fmt_23, 0 };
    static cilist io___337 = { 0, 3, 0, fmt_23, 0 };
    static cilist io___345 = { 0, 6, 0, fmt_31, 0 };
    static cilist io___346 = { 0, 3, 0, fmt_31, 0 };
...
ftnlen filename_len;
{
    ...
    /* Format strings */
    static char fmt_23[] = "(\002\002,f8.6)";
    ...
    static integer ntry;
    static real d, e;
    static integer i, k, m, n;
    static real s;
    extern doublereal chisq_();
    static integer ij, ntries, jkk, tbl[4], row[32];
    extern integer jkreset_();

    /* Fortran I/O blocks */
    static cilist io___379 = { 0, 6, 0, fmt_23, 0 };
    static cilist io___380 = { 0, 3, 0, fmt_23, 0 };
...
8.6)";
    static char fmt_652[] = "(\002\002, f8.6)";
    ...
    /* Fortran I/O blocks */
    static cilist io___417 = { 0, 6, 0, fmt_652, 0 };
    static cilist io___419 = { 0, 3, 0, fmt_652, 0 };
    static cilist io___420 = { 0, 6, 0, fmt_38, 0 };
    static cilist io___421 = { 0, 3, 0, fmt_38, 0 };
...
/* Computing 3rd power */
    ...
    i__1 = nbits + 2;
    alam = r__2 * (r__1 * r__1) / pow_di(&c_b513, &i__1);
    //s_wsfe(&io___394);
...
real *pp;
{
    ...
    static char fmt_29[] = "(i6,f13.0,f13.3)";
...
f8.2,\002 p-value= \002,f8.6)";
    ...
    /* Fortran I/O blocks */
    static cilist io___435 = { 0, 3, 0, 0, 0 };
    static cilist io___436 = { 0, 3, 0, 0, 0 };
    static cilist io___437 = { 0, 6, 0, 0, 0 };
    static cilist io___438 = { 0, 6, 0, 0, 0 };
    static cilist io___440 = { 0, 6, 0, fmt_28, 0 };
    static cilist io___441 = { 0, 3, 0, fmt_28, 0 };
    static cilist io___442 = { 0, 6, 0, fmt_29, 0 };
    static cilist io___443 = { 0, 3, 0, fmt_29, 0 };
    static cilist io___444 = { 0, 6, 0, fmt_27, 0 };
    static cilist io___445 = { 0, 3, 0, fmt_27, 0 };
    static cilist io___446 = { 0, 6, 0, fmt_31, 0 };
    static cilist io___447 = { 0, 3, 0, fmt_31, 0 };
    static cilist io___448 = { 0, 3, 0, 0, 0 };
...
ftnlen filename_len;
{
    ...
    /* Format strings */
    static char fmt_39[] = "(\002\002,2f8.6)";
    static char fmt_27[] = "(\002\002,2f8.6)";
    ...
    /* Fortran I/O blocks */
    static cilist io___470 = { 0, 6, 0, fmt_39, 0 };
    static cilist io___471 = { 0, 3, 0, fmt_39, 0 };
    static cilist io___474 = { 0, 3, 0, fmt_27, 0 };
    static cilist io___475 = { 0, 6, 0, fmt_27, 0 };
...
integer jtbl8_()
{
    ...
    /* Fortran I/O blocks */
    static cilist io___481 = { 0, 1, 0, 0, 0 };
...
ftnlen filename_len;
{
    ...
    /* Fortran I/O blocks */
    static cilist io___516 = { 0, 3, 0, fmt_821, 0 };
    static cilist io___517 = { 0, 6, 0, fmt_821, 0 };
...
real *x;
{
    ...
    ret_val = r_sign(&c_b760, x) + (float).5;
    if (dabs(*x) > (float)7.) {
	return ret_val;
    }
    d__1 = *x;
    cphi = .5 - d_sign(&c_b761, &d__1);
    j = (integer) (dabs(*x) + .5);
    j = min(j,14);
    z = (doublereal) j;
    h = dabs(*x) - z;
...
integer *n;
{
    ...
    if (*n > 20) {
	d__1 = (doublereal) (*x / *n);
	t = (pow_dd(&d__1, &c_b764) - 1 + (float).22222 / *n) / sqrt((float)
		.22222 / *n);
	r__1 = dmin(t,(float)8.);
	ret_val = phi_(&r__1);
	return ret_val;
...
,/,\002     For a sample of 1,000,000 consecutive 5-tuples,\002)";
    static char fmt_273[] = "(\002\002,f8.6)";
    ...
    /* Fortran I/O blocks */
    static cilist io___574 = { 0, 4, 0, fmt_212, 0 };
    static cilist io___578 = { 0, 4, 0, fmt_212, 0 };
    static cilist io___590 = { 0, 3, 0, fmt_271, 0 };
    static cilist io___591 = { 0, 6, 0, fmt_271, 0 };
    static cilist io___592 = { 0, 3, 0, fmt_273, 0 };
    static cilist io___593 = { 0, 6, 0, fmt_273, 0 };
...
void printstart(char *s) 
{
  static char fmt_1[100];

  static cilist io___1 = {0,3,0,fmt_1,0};
  static cilist io___2 = {0,6,0,fmt_1,0};

  sprintf(fmt_1, "(\002begin \002,a%d)", strlen(s));
  s_wsfe(&io___1);
  do_fio(&c__1, s, strlen(s));
  e_wsfe();
  s_wsfe(&io___2);
  do_fio(&c__1, s, strlen(s));
  e_wsfe();

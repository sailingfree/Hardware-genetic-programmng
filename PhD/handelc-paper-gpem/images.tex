...
\usepackage{geometry}
\geometry{verbose,a4paper,tmargin=2cm,bmargin=2cm,lmargin=4cm,rmargin=3cm}
\usepackage{graphics}
\usepackage{rotating}
...
%
\providecommand{\LyX}{L\kern-.1667em\lower.25em\hbox{Y}\kern-.125emX\@}\let\SF@@footnote\ifx\protect\@typeset@protect
...
\resizebox*{!}{1.5in}{\includegraphics{Image102.epsi}}%
\lthtmlpictureZ
\lthtmlcheckvsize\clearpage}

{\newpage\clearpage
\lthtmlpictureA{tex2html_wrap750}%
\resizebox*{!}{1.5in}{\includegraphics{Image103.epsi}}%
\lthtmlpictureZ
\lthtmlcheckvsize\clearpage}
...
\stepcounter{subsection}
{\newpage\clearpage
\lthtmlpictureA{tex2html_wrap904}%
\resizebox*{!}{3in}{\includegraphics{process.eps}}%
\lthtmlpictureZ
\lthtmlcheckvsize\clearpage}
...
\resizebox*{3.5in}{!}{\includegraphics{lfsr.eps}}%
\lthtmlpictureZ
\lthtmlcheckvsize\clearpage}
...
\( Speedup_{time}=Speedup_{cycles}*\frac{Freq_{ppc}}{Freq_{fpga}} \)%
\lthtmlinlinemathZ
\lthtmlcheckvsize\clearpage}
...
\( (a+b)\overline{ab}\equiv (a\overline{b})+(\overline{a}b) \)%
\lthtmlinlinemathZ
\lthtmlcheckvsize\clearpage}

\stepcounter{subsection}
{\newpage\clearpage
\lthtmlfigureA{sideways288}%
\begin{sideways}
Subpopulation size
\end{sideways}%
\lthtmlfigureZ
...
{\newpage\clearpage
\lthtmlfigureA{sideways294}%
\begin{sideways}
Breeding of generation 0
\end{sideways}%
\lthtmlfigureZ
\lthtmlcheckvsize\clearpage}

{\newpage\clearpage
\lthtmlfigureA{sideways296}%
\begin{sideways}
Total Cycles for Run
\end{sideways}%
\lthtmlfigureZ
\lthtmlcheckvsize\clearpage}

{\newpage\clearpage
\lthtmlfigureA{sideways298}%
\begin{sideways}
Gate estimate
\end{sideways}%
\lthtmlfigureZ
...
{\newpage\clearpage
\lthtmlpictureA{tex2html_wrap1210}%
\resizebox*{!}{2in}{\includegraphics{Cycles_per_eval.eps}}%
\lthtmlpictureZ
\lthtmlcheckvsize\clearpage}

{\newpage\clearpage
\lthtmlpictureA{tex2html_wrap1226}%
\resizebox*{!}{2in}{\includegraphics{total_cycles.eps}}%
\lthtmlpictureZ
\lthtmlcheckvsize\clearpage}

{\newpage\clearpage
\lthtmlpictureA{tex2html_wrap1240}%
\resizebox*{!}{2in}{\includegraphics{gate-count.eps}}%
\lthtmlpictureZ
\lthtmlcheckvsize\clearpage}

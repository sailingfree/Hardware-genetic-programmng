...
\vfill{}
\title{Analysis of the Behavior of a Hardware Implementation of GP using
FPGAs and Handel-C}
\vfill{}


\author{{\Large Peter Martin and Riccardo Poli}\\
{\Large Department of Computer Science, }\\
{\Large University of Essex, }\\
{\Large Wivenhoe Park, }\\
{\Large Colchester, CO4 3SQ UK.}}

\maketitle
{\centering {\Large Technical Report CSM-357}\Large \par}

{\centering {\Large Department of Computer Science}\Large \par}

{\centering {\Large University of Essex}\Large \par}
...
ant problem \cite{martin:2002:eurogp2002}. In both cases the work
concentrated on the implementation issues and increasing the clock
speed of the implementation, but put to one side the study of the
behavior of the system with respect to standard GP. Now that the raw
throughput issues have been considered it is time to look at the behavior,
and investigate and analyze some alternative implementation issues.
...
can be detected without the need to implement wide comparators which

...
set xlabel "Number of runs" 0.000000,0.000000  ""
set x2label "" 0.000000,0.000000  ""
set timefmt "%d/%m/%y\n%H:%M"
#set xrange [ 1.000000 : 1000.00 ] noreverse nowriteback
set x2range [ * : * ] noreverse nowriteback  # (currently [-10.0000:10.0000] )
set ylabel "Cost per run (Euros)" 0.000000,0.000000  ""
...
Tgps=24
Tgph=Tgps/500
plot [x=0:1000] (((Chws+Csws)/E)+Cswimpl+(x*Tgps))/x title "Software",(((Chwh+Cswh)/E)+Chwimpl+(x*Tgph))/x title "Hardware"
set output "costbenefit-2.eps"
